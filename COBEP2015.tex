...
\title{Demo of IEEEtran.cls \cite{IEEEhowto:IEEEtranpage} for COBEP 2015}
...
\begin{table}[!h]
	\begin{center}
		\caption{A wrapped table (changed) going nicely inside the text.}\label{wrap-tab:1}
...
\begin{figure}[!h]
	\begin{center}
	\includegraphics[width=0.35\textwidth]{Figs/MHF1F_ix.eps}
